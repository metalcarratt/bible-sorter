...
const bibleVerseCounts: Record<string, number[]> = {
  ...
  Psalms: [
    ...
    28, 22, 35, 45, 48, 43, 14, 31, 7, 10, 10, 9, 8, 18, 19, 2, 29, 176, 7, 8,
  ...
  Ezekiel: [
    ...
    29, 49, 26, 20, 27, 31, 25, 24,
  ],
  Daniel: [21, 49, 33, 34, 30, 28, 28, 27, 27, 21, 45, 13],
...
function buildFlatBibleArray(bibleChapters: BibleChapters) {
  ...
  writeFileSync('run-once-output.txt', JSON.stringify(flat), 'utf8');

  return flat;
}

buildFlatBibleArray(bibleVerseCounts);
